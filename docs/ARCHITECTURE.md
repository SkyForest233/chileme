...
├─ viewmodel/                   # 8 个文件（2026-09-19 #10b-1 … #10b-6 起：VM 的领域函数按领域搬成同包 internal 扩展函数）
│   ├─ AppViewModel.kt          # 全局共享 VM（AndroidViewModel），StateFlow 暴露；304 行 🎯 < 400 达标（#10b-1 前 700、#10b-2 前 590、#10b-3 前 469、#10b-4 前 431、#10b-5 前 363、#10b-6 前 322）
