...
├─ viewmodel/                   # 5 个文件（2026-09-19 #10b-1 / #10b-2 / #10b-3 起：VM 的领域函数按领域搬成同包 internal 扩展函数）
│   ├─ AppViewModel.kt          # 全局共享 VM（AndroidViewModel），StateFlow 暴露；431 行（#10b-1 前 700、#10b-2 前 590、#10b-3 前 469）
