...
- **全项验收**：
  ...
  ⚠️ **10e 已于 2026-09-19 落地**（入口 660 → **317**）⇒ 那条例外**已消失**，两个已知例外现在只剩 `StatsScreen.kt` 一个。
