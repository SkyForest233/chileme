...
> | P1-2 / P1-5 / P1-6 / P1-7 / P1-9 / P1-10 | ❌ 仍未做（`beyondViewportPageCount = 3` 在 `NavChrome.kt:132`（原 `MainActivity.kt:923`，2026-09-16 拆分后改址）；`animateColorScheme` 37 个角色动画；无 `Application` 类/无 DI；双主题渲染层自 2026-09-16 起按第三批 #3 逐对合并，**已完成 7/8 对**、只剩设置页，做法即本节建议的「组件级 style kit」，见 `devlog/2026-09-16.md` §15–§21） |
