...
| ~~中~~ | ~~状态容器纯逻辑单测补全 (B-07)~~（Stats / FoodList / Archive / Home 纯函数单测） | 2026-08-22 | ✅ 已完成（当时新增 16 例；**2026-09-16 校正：仓库现有单测 116 例**，`grep -rh '@Test' app/src/test \| wc -l`，此前本行写的 91 例是 09-15 中途的数字；**2026-09-17 再校正：09-16 那行写的 116 实为 117，新增 `MiuixDialogContentTest` 2 例后现为 119 例**） |
