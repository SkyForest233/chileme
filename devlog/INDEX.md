...
| 日期 | 主题 | 构建状态 |
|---|---|---|
| [2026-08-22](2026-08-22.md) | 修复跨零点 LocalToday 残留 (B-01) + 封面压缩 (B-04) + 引入 Version Catalog (B-02) + 升级过期依赖 (B-03) + 双主题状态层抽离与去重 (B-08) + README/LICENSE (B-05) + **状态层单测补全 (B-07) 与归档搜索恢复支持撤销** | ✅ CI 通过（含 lint 与单测） |
